...
I built this because I have yet to find anything like it that wasnt a super outdated spigot plugin. Plus, this runs outside the server jar so it won't matter what type of minecraft server you have
...
- setup tutorials
- make some sort of manual or automatic trigger for the get_player_heads.py file either manually from the website or on some schedule so new players and skin changes get updated
